    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ParseUserFaqs(
          text,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.UserFaq[]
            } catch (error) {
            throw toBamlError(error);
            }
            }
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            text: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.UserFaq[], types.UserFaq[]>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ParseUserFaqs", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.UserFaq[], types.UserFaq[]>(
                  __raw__,
                  (a): partial_types.UserFaq[] => a,
                  (a): types.UserFaq[] => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
